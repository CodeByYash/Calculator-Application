...
input_frame = Frame(app, width=400, height=100, bd=0, highlightbackground="black", highlightcolor="black", highlightthickness=2)
...
btns_frame = Frame(app, width=400, height=400, bg="light blue")
